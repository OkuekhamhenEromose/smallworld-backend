...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['reset_token'], name='users_user_reset_t_98e3df_idx'),
        ),
        migrations.AddIndex(
            model_name='follow',
            index=models.Index(fields=['to_user', 'created_at'], name='users_follo_to_user_beba02_idx'),
        ),
